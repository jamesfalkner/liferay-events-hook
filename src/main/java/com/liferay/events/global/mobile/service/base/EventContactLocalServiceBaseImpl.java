...
import com.liferay.events.global.mobile.service.EventContactLocalService;
...
/**
 * Provides the base implementation for the event contact local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.events.global.mobile.service.impl.EventContactLocalServiceImpl}.
 * </p>
 *
 * @author James Falkner
 * @see com.liferay.events.global.mobile.service.impl.EventContactLocalServiceImpl
 * @see com.liferay.events.global.mobile.service.EventContactLocalServiceUtil
 * @generated
 */
public abstract class EventContactLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements EventContactLocalService,
        IdentifiableBean {
    ...
    private EventContactLocalServiceClpInvoker _clpInvoker = new EventContactLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.liferay.events.global.mobile.service.EventContactLocalServiceUtil} to access the event contact local service.
     */
    ...
    @Override
    public EventContact addEventContact(EventContact eventContact)
        throws SystemException {
        eventContact.setNew(true);

        return eventContactPersistence.update(eventContact);
    }
     ...
     */
    @Override
    public EventContact createEventContact(long eventContactId) {
        return eventContactPersistence.create(eventContactId);
    }
    ...
    @Override
    public EventContact deleteEventContact(long eventContactId)
        throws PortalException, SystemException {
        return eventContactPersistence.remove(eventContactId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public EventContact deleteEventContact(EventContact eventContact)
        throws SystemException {
        return eventContactPersistence.remove(eventContact);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(EventContact.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return eventContactPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return eventContactPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public EventContact fetchEventContact(long eventContactId)
        throws SystemException {
        return eventContactPersistence.fetchByPrimaryKey(eventContactId);
    }
     ...
     */
    @Override
    public EventContact getEventContact(long eventContactId)
        throws PortalException, SystemException {
        return eventContactPersistence.findByPrimaryKey(eventContactId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return eventContactPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<EventContact> getEventContacts(int start, int end)
        throws SystemException {
        return eventContactPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getEventContactsCount() throws SystemException {
        return eventContactPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public EventContact updateEventContact(EventContact eventContact)
        throws SystemException {
        return eventContactPersistence.update(eventContact);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.liferay.events.global.mobile.model.EventContact",
            eventContactLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = eventContactPersistence.getDataSource();
