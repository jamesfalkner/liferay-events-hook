...
import com.liferay.events.global.mobile.service.MatchLocalService;
...
/**
 * Provides the base implementation for the match local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.events.global.mobile.service.impl.MatchLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class MatchLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements MatchLocalService, IdentifiableBean {
    ...
    private MatchLocalServiceClpInvoker _clpInvoker = new MatchLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.liferay.events.global.mobile.service.MatchLocalServiceUtil} to access the match local service.
     */
    ...
    @Override
    public Match addMatch(Match match) throws SystemException {
        match.setNew(true);

        return matchPersistence.update(match);
    }
     ...
     */
    @Override
    public Match createMatch(long matchId) {
        return matchPersistence.create(matchId);
    }
    ...
    public Match deleteMatch(long matchId)
        ...
        return matchPersistence.remove(matchId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Match deleteMatch(Match match) throws SystemException {
        return matchPersistence.remove(match);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Match.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return matchPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return matchPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return matchPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return matchPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Match fetchMatch(long matchId) throws SystemException {
        return matchPersistence.fetchByPrimaryKey(matchId);
    }
     ...
     */
    @Override
    public Match getMatch(long matchId) throws PortalException, SystemException {
        return matchPersistence.findByPrimaryKey(matchId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return matchPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Match> getMatchs(int start, int end) throws SystemException {
        return matchPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getMatchsCount() throws SystemException {
        return matchPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Match updateMatch(Match match) throws SystemException {
        return matchPersistence.update(match);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.liferay.events.global.mobile.model.Match",
            matchLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = matchPersistence.getDataSource();
